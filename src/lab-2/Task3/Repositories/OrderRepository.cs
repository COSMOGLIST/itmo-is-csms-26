...
public class OrderRepository : IOrderRepository
{
    ...
    public async IAsyncEnumerable<Order> GetByFilterAsync(int cursor, int pageSize, OrderFilterQuery orderFilterQuery, [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        await using NpgsqlConnection connection = await _npgsqlDataSource.OpenConnectionAsync(cancellationToken);
        const string query = """
                             SELECT 
